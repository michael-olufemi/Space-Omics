...
input_dir="/scratch/workspace/michael_olufemi_student_uml_edu-nanopore/space_omics/trimmed4"
...
for file1 in ${input_dir}/*_R1_val_1.fq.gz; do
    ...
    if [[ -f "$file2" ]]; then
        ...
        echo "#SBATCH -p cpu" >> $job_script                     # Partition
        echo "#SBATCH -t 23:50:00" >> $job_script                # Job time limit (20 hours)
